...
contract VerifierWrapper is  INexusVerifierWrapper, StorageProofVerifier { 
    ...
    constructor( IZKSyncNexusManagerRouter zksyncDiamondAddress, SparseMerkleTree smt) StorageProofVerifier(zksyncDiamondAddress,smt)   {
    }

    function parseAndVerify(uint256, bytes32 receipt, bytes calldata data) view external { 
