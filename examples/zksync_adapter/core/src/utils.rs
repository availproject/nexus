...
pub fn parse_proof(proof: Vec<String>) -> Proof {
    ...
    let lookup_s_poly_affine = G1::new(lookup_s_poly_x, lookup_s_poly_y, Fq::one());
    ...
    let lookup_grand_product_affine = G1::new(lookup_grand_product_x, lookup_grand_product_y, Fq::one());
    ...
    let quotient_poly_parts_0_affine = G1::new(quotient_poly_parts_0_x, quotient_poly_parts_0_y, Fq::one());
    ...
    let quotient_poly_parts_1_affine = G1::new(quotient_poly_parts_1_x, quotient_poly_parts_1_y, Fq::one());
    ...
    let quotient_poly_parts_2_affine = G1::new(quotient_poly_parts_2_x, quotient_poly_parts_2_y, Fq::one());
    ...
    let quotient_poly_parts_3_affine = G1::new(quotient_poly_parts_3_x, quotient_poly_parts_3_y, Fq::one());
    ...
    let opening_proof_at_z_x = Fq::from_str(proof_serialized[40]).unwrap();
    let opening_proof_at_z_y = Fq::from_str(proof_serialized[41]).unwrap();
    let opening_proof_at_z_affine = G1::new(opening_proof_at_z_x, opening_proof_at_z_y, Fq::one());

    let opening_proof_at_z_omega_x = Fq::from_str(proof_serialized[42]).unwrap();
    let opening_proof_at_z_omega_y = Fq::from_str(proof_serialized[43]).unwrap();
    ...
    VerificationKey {
        gate_setup: vec![
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "110deb1e0863737f9a3d7b4de641a03aa00a77bc9f1a05acc9d55b76ab9fdd4d".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "2c9dc252441e9298b7f6df6335a252517b7bccb924adf537b87c5cd3383fd7a9".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "04659caf7b05471ba5ba85b1ab62267aa6c456836e625f169f7119d55b9462d2".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "0ea63403692148d2ad22189a1e5420076312f4d46e62036a043a6b0b84d5b410".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "0e6696d09d65fce1e42805be03fca1f14aea247281f688981f925e77d4ce2291".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "0228f6cf8fe20c1e07e5b78bf8c41d50e55975a126d22a198d1e56acd4bbb3dd".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "14685dafe340b1dec5eafcd5e7faddaf24f3781ddc53309cc25d0b42c00541dd".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "0e651cff9447cb360198899b80fa23e89ec13bc94ff161729aa841d2b55ea5be".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "16e9ef76cb68f2750eb0ee72382dd9911a982308d0ab10ef94dada13c382ae73".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "22e404bc91350f3bc7daad1d1025113742436983c85eac5ab7b42221a181b81e".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "0d9b29613037a5025655c82b143d2b7449c98f3aea358307c8529249cc54f3b9".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "15b3c4c946ad1babfc4c03ff7c2423fd354af3a9305c499b7fb3aaebe2fee746".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "2a4cb6c495dbc7201142cc773da895ae2046e790073988fb850aca6aead27b8a".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "28ef9200c3cb67da82030520d640292014f5f7c2e2909da608812e04671a3acf".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "283344a1ab3e55ecfd904d0b8e9f4faea338df5a4ead2fa9a42f0e103da40abc".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "223b37b83b9687512d322993edd70e508dd80adb10bcf7321a3cc8a44c269521".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
        ...
        gate_selectors: vec![
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "1f67f0ba5f7e837bc680acb4e612ebd938ad35211aa6e05b96cad19e66b82d2d".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "2820641a84d2e8298ac2ac42bd4b912c0c37f768ecc83d3a29e7c720763d15a1".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "0353257957562270292a17860ca8e8827703f828f440ee004848b1e23fdf9de2".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "305f4137fee253dff8b2bfe579038e8f25d5bd217865072af5d89fc8800ada24".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
        ...
        permutation: vec![
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "13a600154b369ff3237706d00948e465ee1c32c7a6d3e18bccd9c4a15910f2e5".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "138aa24fbf4cdddc75114811b3d59040394c218ecef3eb46ef9bd646f7e53776".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "277fff1f80c409357e2d251d79f6e3fd2164b755ce69cfd72de5c690289df662".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "25235588e28c70eea3e35531c80deac25cd9b53ea3f98993f120108bc7abf670".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "0990e07a9b001048b947d0e5bd6157214c7359b771f01bf52bd771ba563a900e".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "05e5fb090dd40914c8606d875e301167ae3047d684a02b44d9d36f1eaf43d0b4".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "1d4656690b33299db5631401a282afab3e16c78ee2c9ad9efea628171dcbc6bc".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "0ebda2ebe582f601f813ec1e3970d13ef1500c742a85cce9b7f190f333de03b0".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
        ...
        lookup_table: vec![
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "2c513ed74d9d57a5ec901e074032741036353a2c4513422e96e7b53b302d765b".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "04dd964427e430f16004076d708c0cb21e225056cc1d57418cfbd3d472981468".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "1ea83e5e65c6f8068f4677e2911678cf329b28259642a32db1f14b8347828aac".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "1d22bc884a2da4962a893ba8de13f57aaeb785ed52c5e686994839cab8f7475d".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "0b2e7212d0d9cff26d0bdf3d79b2cac029a25dfeb1cafdf49e2349d7db348d89".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "1301f9b252419ea240eb67fda720ca0b16d92364027285f95e9b1349490fa283".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
            ...
            G1::new(
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "02f7b99fdfa5b418548c2d777785820e02383cfc87e7085e280a375a358153bf".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
                ...
                Fq::from_str(
                    &BigInt::parse_bytes(
                        "09d004fe08dc4d19c382df36fad22ef676185663543703e6a4b40203e50fd8a6".as_bytes(),
                        16,
                    )
                    .unwrap()
                    .to_string(),
