use crate::{
    ...
    types::{Address, ShaHasher, TransactionReceipt, TxSignature},
};
use anyhow::anyhow;
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize, Default, Encode, Decode)]
pub struct StarkProofConditional {
    conditional: H256,
    img_id: H256,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize, Encode, Decode)]
pub enum FutureVerification {
    Default(),
    SparseMerkleTree(H256),
    Risc0StarkProof(StarkProofConditional),
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize, Encode, Decode)]
pub struct Future {
    pub to: Address,
    pub commitment: FutureVerification,
}
...
pub struct Transfer {
    ...
    pub future_commitment: Option<FutureVerification>,
}
